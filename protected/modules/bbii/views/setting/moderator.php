...
$this->bbii_breadcrumbs=array(
	...
	Yii::t('BbiiModule.bbii', 'Settings')=>array('/forum/setting/index'),
	Yii::t('BbiiModule.bbii', 'Moderators')
);

$item = array(
	array('label'=>Yii::t('BbiiModule.bbii', 'Settings'), 'url'=>array('/forum/setting/index')),
	array('label'=>Yii::t('BbiiModule.bbii', 'Forum layout'), 'url'=>array('/forum/setting/layout')),
	array('label'=>Yii::t('BbiiModule.bbii', 'Member groups'), 'url'=>array('/forum/setting/group')),
	array('label'=>Yii::t('BbiiModule.bbii', 'Moderators'), 'url'=>array('/forum/setting/moderator'))
);
?>
<div id="bbii-wrapper">
