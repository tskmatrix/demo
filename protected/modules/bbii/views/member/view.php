...
$this->bbii_breadcrumbs=array(
	...
	Yii::t('BbiiModule.bbii', 'Members')=>array('/forum/member/index'),
...
$item = array(
	...
	array('label'=>Yii::t('BbiiModule.bbii', 'Approval'), 'url'=>array('/forum/moderator/approval'), 'visible'=>$this->isModerator()),
...
<div id="bbii-wrapper">
	...
	<table class="profile"><tr><td>
		...
		<tr>
			...
			<td>
				<?php if($model->contact_email && $this->module->userMailColumn) 	echo Chtml::link(CHtml::image($this->module->getRegisteredImage('User.png'), 'e-mail', array('title'=>Yii::t('BbiiModule.bbii', 'Contact user by e-mail'))), array('/forum/member/mail', 'id'=>$model->id)); ?>
