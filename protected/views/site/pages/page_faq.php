...
<div class="container">
	<div class="row">
        <div class="col-md-9 pagebar">
			<!-- Other Questions -->
            <div><h3 class="content-title">General Questions</h3></div>
            <!-- Accardion -->
			...
			<!-- General Questions -->
            <div><h3 class="content-title">Other Questions</h3></div>
            <!-- Accardion -->
            <div class="panel-group acc-home" id="accordion2">
                <div class="panel panel-default">
                    <div class="panel-heading">
                ...
                <ul class="popular-posts">
                    <li>
                        <a class="bwWrapper" href="single_post.html">
                            <img alt="" src="assets/img/work/work1.jpg">
                        </a>
                    ...
                    <li>
                        <a class="bwWrapper" href="single_post.html">
                            <img alt="" src="assets/img/work/work2.jpg">
                        </a>
                    ...
                    <li>
                        <a class="bwWrapper" href="single_post.html">
                            <img alt="" src="assets/img/work/work3.jpg">
                        </a>
                        <h5><a href="single_post.html">Lorem Ipsum</a></h5>
                        <p>
                            Lorem Ipsum and here goes the title.
